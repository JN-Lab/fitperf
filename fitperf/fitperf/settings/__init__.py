"""
Django settings for fitperf project.
...
SECRET_KEY = 'g0n5hug76u06qdxr*(oln9bf)(^=$9z-v*6ye6=819+hxs^@!h'
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocalesMiddleware',
]

ROOT_URLCONF = 'fitperf.urls'
...
WSGI_APPLICATION = 'fitperf.wsgi.application'
